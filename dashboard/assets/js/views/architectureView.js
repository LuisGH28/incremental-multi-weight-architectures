...
export function renderArchitecture(elements, genotype) {
  ...
  const inputCount = genotype.n_inputs || genotype.n_in || 64;
  const outputCount = genotype.n_outputs || genotype.n_out || 10;
  ...
  html += '<rect x="12" y="6" width="168" height="28" rx="6" class="arch-legend-box"/>';
